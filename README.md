...
3.เมื่อผู้ใช้อยู่ในระยะจอดที่พอดี จะมีเสียงสัญญาณดังขึ้น เพื่อทำให้รู้ว่าถึงจุดที่พอดีแล้ว

![](/Resource/step3.gif)

---

4.เมื่อผู้ใช้จอดรถเสร็จแล้ว ก็สามารถกรอกตำแหน่งที่จอดรถลงในเว็บ https://comproiot.firebaseapp.com/ พอดีรายอะเอียดต่างๆ
...
5.เมื่อกรอกเข้าไปจะเห็นรายละเอียดต่างๆ ทั้ง ตำแหน่งที่จอดรถ เวลาที่เริ่มจอดและระยะเวลาที่จอด
...
6.เมื่อผู้ใช้ขับรถออกแล้ว จำวนวที่จอดในชั้นนั้นก็จะเพิ่มขึ้นเช่นกัน
